...
local FRUITS = {
    ...
    {"Wheat",            "Wheat",            1},
    {"Cherry Blossom",   "Cherry Blossom",   1},
    {"Spring Onion",     "Spring Onion",     1},
    -- Rare
    {"Blood Orange",     "Blood Orange",     2},
    {"Cannon Fruit",     "Cannon Fruit",     2},
    {"Crowned Pear",     "Crowned Pear",     2},
    {"Crystalberry",     "Crystalberry",     2},
    {"Durian",           "Durian",           2},
    {"Ember Fruit",      "Ember Fruit",      2},
    {"Ghost Pepper",     "Ghost Pepper",     2},
    {"Gilded Nectarine", "Gilded Nectarine", 2},
    {"Golden Apple",     "Golden Apple",     2},
    {"Honeysuckle",      "Honeysuckle",      2},
    {"Horned Melon",     "Horned Melon",     2},
    {"Jackpot Jackfruit","Jackpot Jackfruit",2},
    {"Martian Melon",    "Martian Melon",    2},
    {"Moonflower",       "Moonflower",       2},
    {"Nectarine",        "Nectarine",        2},
    {"Spiked Rambutan",  "Spiked Rambutan",  2},
    {"Striped Starfruit","Striped Starfruit",2},
    {"Beanstalk",        "Beanstalk",        2},
    {"Popcorn Poppy",    "Popcorn Poppy",    2},
    -- Exotic / Special
